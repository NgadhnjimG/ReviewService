...
namespace ReviewService.Controllers
{
    ...
    public class StarReviewsController : ControllerBase
    {
        ...
        // GET: api/StarReviews
        [HttpGet]
        public async Task<ActionResult<IEnumerable<DoctorReviewDataObject>>> GetStarReview()
        {
            var reviews=new List <DoctorReviewDataObject>();
            var doctors = this.dbConnection.Doctor.ToList();
            foreach (var doc in doctors) {
                var specificreview= new DoctorReviewDataObject();
                ...
                specificreview.DoctorId = doc.ID;
                specificreview.StarReview = finalrev;
                var commentsClass = this.dbConnection.Comments.Where(x => x.DoctorId == doc.ID).ToList();
